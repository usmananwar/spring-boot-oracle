...
public class OverheadDataService {
	...
	public int getThrityThreeKvCount(boolean isZone1Included, boolean isZone2Included, boolean isZone3Included, String geometry) {
		...
		int result = 0;
		if (isZone1Included) {
			result = apiDataService.getCountByZonesFromMapServer5(Constants.MedcZone1, whereClause, geometry);
		}

		if (isZone2Included) {
			result = result + apiDataService.getCountByZonesFromMapServer5(Constants.MazonZone2, whereClause, geometry);
			result = result + apiDataService.getCountByZonesFromMapServer5(Constants.TanweerZone2, whereClause, geometry);
		}

		if (isZone3Included) {
			result = result + apiDataService.getCountByZonesFromMapServer5(Constants.MajanZone3, whereClause, geometry);
		}
		return result;
	}
	...
	public int getOneVCount(boolean isZone1Included, boolean isZone2Included, boolean isZone3Included, String geometry) {
		...
		int result = 0;
		if (isZone1Included) {
			result = apiDataService.getCountByZonesFromMapServer4(Constants.MedcZone1, whereClause, geometry);
		}

		if (isZone2Included) {
			result = result + apiDataService.getCountByZonesFromMapServer4(Constants.MazonZone2, whereClause, geometry);
			result = result + apiDataService.getCountByZonesFromMapServer4(Constants.TanweerZone2, whereClause, geometry);
		}

		if (isZone3Included) {
			result = result + apiDataService.getCountByZonesFromMapServer4(Constants.MajanZone3, whereClause, geometry);
		}
		return result;
	}
}
